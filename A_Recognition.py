...
import telepot
bot = telepot.Bot('6978359051:AAEfGFhQBce0W0LJAoVMdHEBQYZwaPQ1OUQ')
bot2=telepot.Bot("7854223119:AAGjqwlNJqb0Z_V_F1GGkjwedNPZVOhDZ-U")
ch_id="1306083300"
...
def predictions(video_dir, model, nb_frames = 25, img_size = 224):
    ...
    for i in range(len(preds)):
        ...
        bot2.sendMessage(ch_id, str(classes[preds[i]]+' detected'))
    cap = cv2.VideoCapture(video_dir)
    i=0
    frames = []
    while(cap.isOpened() and i<nb_frames):
