...
EMAIL_SUBJECT = "ALERT: Explosion Detected!"
...
class AlertManager:
            ...
            try:
                if not self.alert_queue.empty():
                    ...
                    if current_time - self.last_alert_time > self.min_interval:
                        ...
                        email_img_path = str(self.email_dir / f"explosion_{timestamp}.jpg")
    ...
    def _send_telegram_alert(self, detection_info, confidence):
        """Send Telegram alert"""
        try:
            alert_message = f"Explosion detected with confidence {confidence:.2f}"
    ...
    def _send_email_alert(self, image_path, detection_info):
        """Send email with the detected explosion image"""
        try:
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if save_img or save_crop or view_img:  # Add bbox to image
                            ...
                            alert_manager.add_alert(im0_annotated, detection_info, confidence)
